...
int main() {
    ...
    int max_records_in_block = floor(blockSize/sizeof(Record));
    ...
    std::cerr << "number of ll in block: " << numPtrInLL << std::endl;
    ...
    cout << "find records with numVotes = 500" << endl;
    bplustree.FindRange(120, 120);
